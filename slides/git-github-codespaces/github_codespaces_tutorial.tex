...
Once we have been through the file, make one small edit of your own. Either:
\vspace{0.7em}

\begin{columns}[T,onlytextwidth]
  \column{0.46\textwidth}
  \textbf{In section 6}, the histogram is drawn with 40 bars. Change it to 20
  and run that block again.

  \column{0.46\textwidth}
  \textbf{In section 5}, the rows are filtered to salaries quoted in US
  dollars. Change it to euros and see how many postings remain.
\end{columns}
