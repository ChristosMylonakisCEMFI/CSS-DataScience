...
\begin{wideitemize}
  ...
  \item The price of a job attribute: location, skills, an amenity.
...
\vspace{0.6em}
\begin{wideitemize}
  \item Same posting, same text --- only the city changes.
  \item So the gap is the price of location, nothing else.
\end{wideitemize}
\end{frame}
...
% =============================================================================
\begin{frame}{3. The price of an amenity: remote work}
\begin{wideitemize}
  \item Remote work is an amenity: workers value it directly.
  \item For an amenity, the price should be negative --- you pay for it.
  \item That negative price is the compensating differential.
  \item Mas and Pallais (2017) estimate it near $-8\%$.
\end{wideitemize}
\end{frame}
...
\begin{wideitemize}
  ...
  \item Hold the job fixed and the price falls to about zero.
  \item So no compensating differential in posted pay here.
  \item The tightest comparison rests on 42 postings.
\end{wideitemize}
\end{frame}
