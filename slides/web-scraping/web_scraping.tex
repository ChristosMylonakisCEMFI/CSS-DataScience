...
\setbeamertemplate{footline}{%
  \hfill\color{Grey}\scriptsize\insertframenumber/\inserttotalframenumber\hspace{0.6cm}\vspace{0.25cm}}
...
\begin{wideitemize}
  ...
  \item Mas and Pallais (2017) estimate it near $-8\%$ on average.
  \item But the distribution is right-skewed: many value it at zero.
\end{wideitemize}
\end{frame}
